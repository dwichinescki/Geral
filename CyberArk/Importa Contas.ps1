...
$urlBase = "https://ca.paranabanco.b.br/PasswordVault/API/"
...
#$Contas = Import-Csv -Path C:\Users\luizfmm\Downloads\Cyberark.csv
$Contas = Import-Csv C:\Users\luizfmm\Downloads\Luiz.csv | Where-Object {$_."Login Name" -eq ""}
...
foreach ($conta in $Contas) {
    ...
    $body = @{
        ...
        safeName = "P-PERSONAL-NETWORK-LUIZ"
        secretType = "password"
